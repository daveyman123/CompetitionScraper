...
class MySpider(scrapy.Spider):
        name = "AStorageInnClarkson"

        
	
	allowed_domains = ['https://storageinns.net']
	start_urls = ['http://www.storageinns.net/p/self_storage/sizes_prices_9704/ellisville-mo-63021/a-storage-inn-clarkson-9704']
	...
	def parse(self, response):
                ...
                url='http://www.storageinns.net/p/self_storage/sizes_prices_9704/ellisville-mo-63021/a-storage-inn-clarkson-9704'
		...
		outside_units = ["10 x 15","5 x 5", "5 x 15","10 x 10","10 x 20","10 x 25", "10 x 30", "10 x 40", "10 x 14", "5 x 10"]
